...
public class LocacaoDAO extends DAO<Locacao> {
    ...
    public List<Locacao> obterTs() {
        ...
        try {
            ...
            Logger lgr = Logger.getLogger(LocacaoDAO.class.getName());
            lgr.log(Level.SEVERE, e.getMessage(), e);
        }
        sql = null;
        return ls;
    }
    public List<Locacao> obterTs_RelatorioLocacoesCliente() {
        List<Locacao> ls = new ArrayList<>();
        params.clear();
    ...
    @Override
    public void operacao(Locacao l, String operacao) {
        params.clear();
    ...
    protected RowMapping getMapa() {
        return new RowMapping() {
            @Override
            public Locacao mapeamento(ResultSet rs) throws SQLException {
